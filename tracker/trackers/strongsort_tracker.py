...
from .matching import chi2inv95, linear_assignment, iou_distance, embedding_distance
...
class StrongSortTracker(BaseTracker):
    ...
    def gated_metric(self, tracks, dets):
        ...
        dets: List[STrack]
        """
        appearance_dist = embedding_distance(tracks=tracks, detections=dets, metric='cosine')
