"""Copied from torch-reid repo https://github.com/KaiyangZhou/deep-person-
reid/"""
...
model_urls = {
    # 1.0: top-1 71.3
    'mobilenetv2_x1_0': 'https://drive.google.com/uc?id=1q1WU2FETRJ3BXcpVtfJUuqq4z3psetds',
    # 1.4: top-1 73.9
    'mobilenetv2_x1_4': 'https://drive.google.com/uc?id=12uD5FeVqLg9-AFDju2L7SQxjmPb4zpBN', }
...
class MobileNetV2(nn.Module):
    ...
    def _construct_fc_layer(self, fc_dims, input_dim, dropout_p=None):
        ...
        assert isinstance(fc_dims,
                          (list, tuple)), 'fc_dims must be either list or tuple, but got {}'.format(type(fc_dims))
...
def mobilenetv2_x1_0(num_classes, loss='softmax', pretrained=True, **kwargs):
    ...
    if pretrained:
        ...
        import warnings
        warnings.warn('The imagenet pretrained weights need to be manually downloaded from {}'.format(
