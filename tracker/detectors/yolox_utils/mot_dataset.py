...
class VisDroneDataset(MOTDataset):
    ...
    def __init__(self, data_dir=None, json_file='train_half.json', name='train', img_size=(608, 1088), preproc=None):
        ...
        self.VisD_dict = {'train': 'VisDrone2019-MOT-train', 'test': 'VisDrone2019-MOT-test-dev'}
    ...
    def pull_item(self, index):
        ...
        # )
        img_file = os.path.join(self.DATA_ROOT, self.VisD_dict[self.name], 'sequences', file_name)
        img = cv2.imread(img_file)
        assert img is not None
