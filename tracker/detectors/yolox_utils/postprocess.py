...
def postprocess_yolox(out, num_classes, conf_thresh, nms_thresh, img, ori_img):
    """convert out to  -> (tlbr, conf, cls)"""

    out = postprocess(out, num_classes, conf_thresh, nms_thresh)[0]  # (tlbr, obj_conf, cls_conf, cls)
